package com.openclassrooms.mddapi.infrastructure.featuregroup.post.mapper;
...
public class PostMapper {
    ...
    public PostPersistence toPersistence(Post post) {
        PostPersistence dbPost = this.modelMapper.map(
            post, 
            com.openclassrooms.mddapi.infrastructure.persistence.entity.PostPersistence.class);
